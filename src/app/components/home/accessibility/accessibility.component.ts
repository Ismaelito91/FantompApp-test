...
const PAGE_CODE = "2.8_accessibilite";
...
export class AccessibilityComponent {
   ...
   private loadRootPage(): void {
      let pageAccessibility = this.pageComponentUtils.getComponentByCode(PAGE_CODE);
      this.page.set(pageAccessibility);
         ...
         this.pageComponentService
            ...
            .subscribe({
               next: (data) => {
                  ...
                  pageAccessibility = this.pageComponentUtils.getComponentByCode(PAGE_CODE);
                  this.page.set(pageAccessibility);
               },
